import {
  Newspaper, Heart, Mail, Eye, ShieldQuestion, Video, Telescope,
...
export const securityGames = [
  ...
  { id: 8, name: 'Escape Room', icon: Telescope, color: 'bg-teal-400', route: 'datagevaar', description: 'Jouw data in gevaar, of niet?', externalUrl: 'https://hackaton.badeendensoep.nl/Pages/levelSelect.html' },
